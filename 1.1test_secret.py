...
with torch.no_grad():
    for focal, t_mat in tqdm(render_poses):
        ...
        cv2.imwrite('outputs/secret_%d.jpg' % count, im)
...
imageio.mimsave("./outputs/secret.gif", reconstructed, fps = 8)
print("Finished.")
...
mcubes.export_obj(vertices, triangles, "./outputs/secret.obj")
print("Finished.")
